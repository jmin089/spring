	  ...
	  <div>
	   <h1>게시글보기</h1>
		   <table>
		     ...
		     <tr>
		       <th>날짜</th>
		       <td>${bdto.bdate} / ${bdate}</td>
		     </tr>
		     <tr>
		       <th>제목</th>
		       <td>${bdto.btitle} / ${btitle}</td>
		     </tr>
		     <tr>
		       <th>내용</th>
		       <td>${bdto.bcontent} / ${bcontent}</td>
		     </tr>
		     <tr>
		       <th>이미지</th>
		       <td>${bdto.bfile} / ${bfile}</td>
		     </tr>
		   </table>
		   <a href="noticeInsert"><button type="button" id="fbtn">게시글수정</button></a>
