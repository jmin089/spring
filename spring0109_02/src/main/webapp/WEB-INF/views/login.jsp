...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?client_id=24a08db200fb154e939f596f923fc142&redirect_uri=http://localhost:8000/kakao/oauth&response_type=code" style="text-decoration: none;">
      <li class="kakao"></li>
      </a>
      <li class="naver"></li>
