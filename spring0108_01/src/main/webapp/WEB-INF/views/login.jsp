...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?client_id=38422562af8962b41f4d3e3973c6eef1&redirect_uri=http://localhost:8000/kakao/oauth&response_type=code">
        <li class="kakao"></li>
      </a>
      <li class="naver"></li>
