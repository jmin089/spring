			...
			<div id="contents">
				<div id="member">
						...
						<table summary="이름, 아이디, 비밀번호, 비밀번호 확인, 이메일, 이메일수신여부, 주소, 휴대폰, 유선전화, 생년월일 순으로 회원가입 정보를 등록할수 있습니다." class="memberWrite" border="1" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li><input type="text" id="email" name="email" class="w134" /></li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li>
												<input type="text" id="address" name="address" class="w134" />&nbsp;
											</li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li>&nbsp;<span class="valign">-</span>&nbsp;</li>
											<li><input type="text" class="w74" maxlength="4" name="phone_b"/> <span class="valign">-</span>&nbsp;</li>
											<li class="r10"><input type="text" class="w74" maxlength="4" name="phone_c"/></li>
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>
								<li><a class="nbtnbig">취소하기</a></li>
								<li><a class="sbtnMini saveBtn">가입하기</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
