		...
		<div id="outbox">		
				...
				$(".sbtn").click(function(){
					...
					$.ajax({
						...
						success:function(data){
							alert("성공")
							if(data == "1"){  //result 타입이 String일 경우 Impl에 내용과 동일 "1" -> "로그인성공"
								alert("로그인 성공했습니다.");
								location.href = "/";
							}else{
								alert("로그인 실패했습니다.");
			...
			<div id="contents">
				<div id="member">
					...
					<h3>회원 로그인</h3>
					<form action="login" name="loginFrm" method="post" id="loginFrm">
					<div class="informbox">
						<div class="inform">
							<ul>
							...
							<div class="btn"><a style="cursor : pointer;" class="sbtn">로그인</a></div>
