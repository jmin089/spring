				...
				<div id="customer">
					...
					<div class="replyBox">
						<ul>
							...
							<li class="btn">
								<a href="#" class="rebtn">저장하기</a>
								<a href="#" class="rebtn">취소하기</a>
							</li>
						</ul>
						...
						<ul>
							...
							<li class="btn">
								<a href="#" class="rebtn">수정하기</a>
								<a href="#" class="rebtn">삭제하기</a>
							</li>
						</ul>
					...
					<div class="btnArea btline">
						<div class="bRight">
							<ul>
								<li><a href="#" class="nbtnbig mw">수정하기</a></li>
								<li><a href="#" class="nbtnbig mw">삭제하기</a></li>
