			...
			<script type="text/javascript">
				$(function(){
					...
					$("#idbtn").click(function(){
						...
						$.ajax({
							url:"/member/a_idsearch",
							type:"post",
							data:{"name":name, "email":email},
							dataType:"text",
							success:function(data){
				                console.log(data);
								//alert("이름, 이메일을 확인하였습니다.");
								if(data == "fail"){
									alert("이름, 이메일이 존재하지 않습니다. 다시 확인해주세요.")
								}else{
									alert("아이디를 찾았습니다.")
									//아이디 확인페이지로 이동 (id.jsp)
					...
					$("#pwbtn").click(function(){
						...
						$.ajax({
							...
							success:function(data){
								if(data=="success"){
									alert("아이디, 이메일을 확인하여, 메일 발송되었습니다.");
								}else{
									alert("아이디, 이메일을 다릅니다. 다시 입력하세요.");
								}
				                console.log(data);
							},
							error:function(){
					...
					<div class="informbox">
						<div class="inform">
							<ul>
								...
								<li><input type="text" name="email" id="email" class="emailType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='emailType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
							</ul>

							<div class="btn"><a id="idbtn" name="idbtn" class="gbtn" style="cursor: pointer;">아이디 찾기</a></div>
						</div>
					</div>
					...
					<div class="informbox">
						<div class="inform">
							<ul>
								...
								<li><input type="text" name="email2" id="email2" class="emailType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='emailType'}else {this.className='mfocusnot'}" /></li>
							</ul>

							<div class="btn"><a id="pwbtn" name="pwbtn" class="gbtn" style="cursor: pointer;">비밀번호 찾기</a></div>
						</div>
					</div>
