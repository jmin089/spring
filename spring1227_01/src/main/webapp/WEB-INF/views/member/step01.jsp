					...
					<div class="btnArea">
						<div class="bCenter2">
							<ul>
								...
								<li><a href="#" class="nbtnMini2 c_pointer">이메일발송</a></li>
								<li class="w201"><hr></li>
								<li class="r10"><input type="text" id="pwcode" class="w200" /></li>
								<li><a name="pwbtn" id="pwbtn" class="sbtnMini2 c_pointer">비밀번호인증</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
