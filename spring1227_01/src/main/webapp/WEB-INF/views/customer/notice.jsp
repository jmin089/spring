				...
				<div id="customer">
					...
					<div class="bwright">
						...
						<c:if test="${map.page >= map.maxPage}">
							...
							<a href="notice?page=${map.maxPage}" class="n"><img src="../images/btn/btn_next2.gif" alt="마지막페이지로"/></a>
						</div>
						<!-- //페이징이동1 -->
					</div>
<!-- 게시글 검색 -->
					...
					<form action="notice" name="search" method="get">
						<div class="search">
							<ul>
								...
								<li><input type="text" class="searchInput" name="searchWord" id="searchWord"/></li>
								<li class="web"><a href="#" type="submit"><img src="../images/btn/btn_search.gif" alt="검색" /></a></li>
