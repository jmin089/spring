			...
			<div id="contents">
				<div id="customer">
					...
					<script>
						$(function(){
							...
							$(document).on("click",".delBtn",function(){
								//alert("삭제버튼 클릭")							
								//alert("부모의 보모 id : "+$(this).parent().parent().attr("id"));							
								//alert("부모의 보모 id : "+$(this).closest("ul").attr("id")); //closest : 가장 근처에 있는 ul을 찾아라				
							...
							$(document).on("click",".updateBtn",function(){
								...
								alert("댓글 수정을 합니다.");
								//alert("부모의 보모 id : "+$(this).parent().parent().attr("id"));
								//alert("부모의 prev() : "+$(this).parent().prev().text());
								//alert("부모의 prev().prev() : "+$(this).parent().prev().prev().text());
								//alert("부모의 span : "+$(this).parent().parent().find("span").text());
								...
								$("#"+cno).html(hdata); //html 초기화(모두삭제) 후 추가
								temp = 1;               //수정창이 열려있음.
							});  //댓글 수정 updateBtn
					...
					<div class="btnArea btline">
						<div class="bRight">
							<ul>
								<li><a id="bupdateBtn" class="nbtnbig">수정하기</a></li>
								<li><a href="#" class="sbtnMini mw">삭제하기</a></li>
								<li><a href="#" class="nbtnbig">답변달기</a></li>
								<li><a href="#" class="sbtnMini mw">목록보기</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
