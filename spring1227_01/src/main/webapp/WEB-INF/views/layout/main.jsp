	...
	<div id="header">
		...
		<div id="snbBox">
			...
			<div id="quickmenu">
				...
				<ul>
					<li><a href="/layout/chart">CHART_EVENT</a></li>
					<li><a href="customer/notice">CUSTOMER</a></li>
					<li><a href="/layout/publicData">DATA_COMMUNITY</a></li>
				</ul>
			</div>
			<div id="snb">
				<ul>
				...
				<c:if test="${session_id != null}">
					...
					<li><a href="/layout/bikeData">BIKE_MY PAGE</a></li>
					<li><a href="/layout/screenData">스트린_CART</a></li>
				</ul>
