...
<body>
	...
	<section>
		<form name="agreeFrm" id="agreeFrm" method="post" action="join03">
			...
			<fieldset class="fieldset_class">
				...
				<dl id="join_id_dl">
							...
							$("#idCheckBtn").click(function(){
								...
								$.ajax({
									...
									success:function(data){
										if(data == "사용가능"){
											alert("아이디 사용가능합니다.")
											$("#idCheckBtn_m").text("아이디 사용가능")
											$("#idCheckBtn_m").css({"color":"blue", "font-weight":"700"})
										}else{
											$("#idCheckBtn_m").text("아이디 사용불가능")
											$("#idCheckBtn_m").css({"color":"red", "font-weight":"700"})
										}
										console.log("join02 data : "+data)
									},
									error:function(){
										alert("실패")
									}
					...
					<dd>
						...
						<span id="idCheckBtn_m">중복확인을 꼭꼭꼭 하세요</span>
